 ...
 * @status
 */
public class geography implements TalendJob {
	...
	private final String jobName = "geography";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(geography.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class geographyStruct implements routines.system.IPersistableRow<geographyStruct> {
		final static byte[] commonByteArrayLock_FIRST_geography = new byte[0];
		static byte[] commonByteArray_FIRST_geography = new byte[0];
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final geographyStruct other = (geographyStruct) obj;
		...
		public void copyDataTo(geographyStruct other) {
		...
		public void copyKeysDataTo(geographyStruct other) {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_FIRST_geography.length) {
					if (length < 1024 && commonByteArray_FIRST_geography.length == 0) {
						commonByteArray_FIRST_geography = new byte[1024];
					} else {
						commonByteArray_FIRST_geography = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_FIRST_geography, 0, length);
				strReturn = new String(commonByteArray_FIRST_geography, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_FIRST_geography, 0, length);
				strReturn = new String(commonByteArray_FIRST_geography, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FIRST_geography) {
		 ...
		 * Compare keys
		 */
		public int compareTo(geographyStruct other) {
	...
	public void tDBInput_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				geographyStruct geography = new geographyStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "geography");
				}
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:45G4StNDtR8fOy1hVai2+RaJ3wN/v/5I0oJajTjUhVU=");
				...
				String insert_tDBOutput_1 = "INSERT INTO `" + "geography_dim"
						+ "` (`STREET_ID`,`CONTINENT_NAME`,`COUNTRY`,`STATE_CODE`,`STATE_NAME`,`PROVINCE_NAME`,`REGION_NAME`,`COUNTY_NAME`,`CITY_NAME`,`POSTAL_CODE_ID`,`STREET_NAME`) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
...
// # Outputs initialization
				geographyStruct geography_tmp = new geographyStruct();
// ###############################
				...
				final String decryptedPassword_tDBInput_4 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:yelKzEZZMWE792opsQoG2jAF6unOpcN1pDMrAg==");
				...
				try {
					...
					while (rs_tDBInput_4.next()) {
						...
						if (colQtyInRs_tDBInput_4 < 1) {
							...
							row1.STREET_ID = rs_tDBInput_4.getDouble(1);
						...
						if (colQtyInRs_tDBInput_4 < 2) {
							...
							row1.COUNTRY = routines.system.JDBCUtil.getString(rs_tDBInput_4, 2, false);
						}
						if (colQtyInRs_tDBInput_4 < 3) {
							row1.STREET_NAME = null;
						} else {

							row1.STREET_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_4, 3, false);
						}
						if (colQtyInRs_tDBInput_4 < 4) {
							row1.CITY_ID = null;
						} else {

							row1.CITY_ID = rs_tDBInput_4.getDouble(4);
							if (rs_tDBInput_4.wasNull()) {
								row1.CITY_ID = null;
							}
						}
						if (colQtyInRs_tDBInput_4 < 5) {
							...
							row1.POSTAL_CODE = routines.system.JDBCUtil.getString(rs_tDBInput_4, 5, false);
						}
						if (colQtyInRs_tDBInput_4 < 6) {
							row1.FROM_STREET_NUM = null;
						} else {

							row1.FROM_STREET_NUM = rs_tDBInput_4.getDouble(6);
							if (rs_tDBInput_4.wasNull()) {
								row1.FROM_STREET_NUM = null;
							}
						}
						if (colQtyInRs_tDBInput_4 < 7) {
							...
							row1.TO_STREET_NUM = rs_tDBInput_4.getDouble(7);
							if (rs_tDBInput_4.wasNull()) {
								row1.TO_STREET_NUM = null;
							}
						}
						if (colQtyInRs_tDBInput_4 < 8) {
							...
							row1.CITY_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_4, 8, false);
						}
						if (colQtyInRs_tDBInput_4 < 9) {
							row1.COUNT = null;
						} else {

							row1.COUNT = rs_tDBInput_4.getDouble(9);
							if (rs_tDBInput_4.wasNull()) {
								row1.COUNT = null;
							}
						}
						if (colQtyInRs_tDBInput_4 < 10) {
							...
							row1.COUNTY_ID = rs_tDBInput_4.getDouble(10);
							if (rs_tDBInput_4.wasNull()) {
								row1.COUNTY_ID = null;
							}
						}
						if (colQtyInRs_tDBInput_4 < 11) {
							...
							row1.POSTAL_CODE_ID = rs_tDBInput_4.getDouble(11);
							if (rs_tDBInput_4.wasNull()) {
								row1.POSTAL_CODE_ID = null;
							}
						}
						...
						if (tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
							...
							// and it contains more one result from keys : row2.COUNTY_ID = '" +
							// row2HashKey.COUNTY_ID + "'");
						} // G 071
						...
						while ((tHash_Lookup_row4 != null && tHash_Lookup_row4.hasNext()) || forceLooprow4) { // G_TM_M_043
							...
							if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
								...
								row5HashKey.CONTINENT_ID = row4.CONTINENT_ID;
							...
							if (tHash_Lookup_row5 != null && tHash_Lookup_row5.getCount(row5HashKey) > 1) { // G 071
								...
								// and it contains more one result from keys : row5.CONTINENT_ID = '" +
								// row5HashKey.CONTINENT_ID + "'");
							} // G 071
							...
							if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
								...
								row3HashKey.COUNTRY = row4.COUNTRY;
							...
							if (tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071
								...
								// row3HashKey.STATE_ID + "', row3.COUNTRY = '" + row3HashKey.COUNTRY + "'");
							} // G 071
...
// # Output table : 'geography'
									geography_tmp.STREET_ID = row1.STREET_ID;
									geography_tmp.CONTINENT_NAME = row5.CONTINENT_NAME;
									geography_tmp.COUNTRY = row2.COUNTRY;
									geography_tmp.STATE_CODE = row3.STATE_CODE;
									geography_tmp.STATE_NAME = row3.STATE_NAME;
									geography_tmp.PROVINCE_NAME = row2.PROVINCE_NAME;
									geography_tmp.REGION_NAME = row2.REGION_NAME;
									geography_tmp.COUNTY_NAME = row2.COUNTY_NAME;
									geography_tmp.CITY_NAME = row1.CITY_NAME;
									geography_tmp.POSTAL_CODE_ID = row1.POSTAL_CODE_ID;
									geography_tmp.STREET_NAME = row1.STREET_NAME;
									geography = geography_tmp;
...
// Start of branch "geography"
							if (geography != null) {
								...
								if (geography.STREET_ID == null) {
									pstmt_tDBOutput_1.setNull(1, java.sql.Types.DOUBLE);
								} else {
									pstmt_tDBOutput_1.setDouble(1, geography.STREET_ID);
								}

								if (geography.CONTINENT_NAME == null) {
									pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(2, geography.CONTINENT_NAME);
								}

								if (geography.COUNTRY == null) {
									pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(3, geography.COUNTRY);
								}

								if (geography.STATE_CODE == null) {
									pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(4, geography.STATE_CODE);
								}

								if (geography.STATE_NAME == null) {
									pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(5, geography.STATE_NAME);
								}

								if (geography.PROVINCE_NAME == null) {
									pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(6, geography.PROVINCE_NAME);
								}

								if (geography.REGION_NAME == null) {
									pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(7, geography.REGION_NAME);
								}

								if (geography.COUNTY_NAME == null) {
									pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(8, geography.COUNTY_NAME);
								}

								if (geography.CITY_NAME == null) {
									pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(9, geography.CITY_NAME);
								}

								if (geography.POSTAL_CODE_ID == null) {
									pstmt_tDBOutput_1.setNull(10, java.sql.Types.DOUBLE);
								} else {
									pstmt_tDBOutput_1.setDouble(10, geography.POSTAL_CODE_ID);
								}

								if (geography.STREET_NAME == null) {
									pstmt_tDBOutput_1.setNull(11, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(11, geography.STREET_NAME);
								}
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "geography");
				}
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_1 - inputs:(row1,row3,row2,row4,row5) outputs:(geography)
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:RF3KIJv0tf00nKbDgTYiqxGwI3JZrr29E9ofVA==");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							row3.STATE_ID = rs_tDBInput_1.getDouble(1);
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							row3.STATE_TYPE = rs_tDBInput_1.getDouble(2);
							if (rs_tDBInput_1.wasNull()) {
								row3.STATE_TYPE = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 3) {
							...
							row3.STATE_CODE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
						}
						if (colQtyInRs_tDBInput_1 < 4) {
							row3.STATE_NAME = null;
						} else {

							row3.STATE_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
						}
						if (colQtyInRs_tDBInput_1 < 5) {
							row3.COUNTRY = null;
						} else {

							row3.COUNTRY = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
						}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:fqzX5lbFVozK8nluxRT7XMhcst4I9uqSZjK66g==");
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							...
							row2.COUNTY_ID = rs_tDBInput_2.getDouble(1);
						...
						if (colQtyInRs_tDBInput_2 < 2) {
							...
							row2.COUNTY_TYPE = rs_tDBInput_2.getDouble(2);
							if (rs_tDBInput_2.wasNull()) {
								row2.COUNTY_TYPE = null;
							}
						}
						if (colQtyInRs_tDBInput_2 < 3) {
							...
							row2.COUNTY_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_2, 3, false);
						}
						if (colQtyInRs_tDBInput_2 < 4) {
							row2.PROVINCE_TYPE = null;
						} else {

							row2.PROVINCE_TYPE = rs_tDBInput_2.getDouble(4);
							if (rs_tDBInput_2.wasNull()) {
								row2.PROVINCE_TYPE = null;
							}
						}
						if (colQtyInRs_tDBInput_2 < 5) {
							...
							row2.PROVINCE_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_2, 5, false);
						}
						if (colQtyInRs_tDBInput_2 < 6) {
							row2.REGION_NAME = null;
						} else {

							row2.REGION_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_2, 6, false);
						}
						if (colQtyInRs_tDBInput_2 < 7) {
							row2.REGION_TYPE = null;
						} else {

							row2.REGION_TYPE = rs_tDBInput_2.getDouble(7);
							if (rs_tDBInput_2.wasNull()) {
								row2.REGION_TYPE = null;
							}
						}
						if (colQtyInRs_tDBInput_2 < 8) {
							...
							row2.STATE_ID = rs_tDBInput_2.getDouble(8);
							if (rs_tDBInput_2.wasNull()) {
								row2.STATE_ID = null;
							}
						}
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url_tDBInput_3 = "jdbc:ucanaccess://" + "C:/Users/bechi/Downloads/orion.mdb"
						+ ";jackcessOpener=org.talend.ucanaccess.encrypt.CryptCodecOpener;singleConnection=true";
				String dbUser_tDBInput_3 = "";

				final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:35Rdk6xyCcPb74jg4e4RTAL3H2rLe9G2fkh/BA==");
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
						...
						if (colQtyInRs_tDBInput_3 < 1) {
							...
							row4.COUNTRY = routines.system.JDBCUtil.getString(rs_tDBInput_3, 1, false);
						}
						if (colQtyInRs_tDBInput_3 < 2) {
							row4.COUNTRY_NAME = null;
						} else {

							row4.COUNTRY_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_3, 2, false);
						}
						if (colQtyInRs_tDBInput_3 < 3) {
							row4.POPULATION = null;
						} else {

							row4.POPULATION = rs_tDBInput_3.getDouble(3);
						...
						if (colQtyInRs_tDBInput_3 < 4) {
							...
							row4.COUNTRY_ID = rs_tDBInput_3.getDouble(4);
							if (rs_tDBInput_3.wasNull()) {
								row4.COUNTRY_ID = null;
							}
						}
						if (colQtyInRs_tDBInput_3 < 5) {
							row4.CONTINENT_ID = null;
						} else {

							row4.CONTINENT_ID = rs_tDBInput_3.getDouble(5);
							if (rs_tDBInput_3.wasNull()) {
								row4.CONTINENT_ID = null;
							}
						}
						if (colQtyInRs_tDBInput_3 < 6) {
							row4.COUNTRY_FORMERNAME = null;
						} else {

							row4.COUNTRY_FORMERNAME = routines.system.JDBCUtil.getString(rs_tDBInput_3, 6, false);
						}
						...
						row4_HashRow.COUNTRY_NAME = row4.COUNTRY_NAME;

						row4_HashRow.POPULATION = row4.POPULATION;

						row4_HashRow.COUNTRY_ID = row4.COUNTRY_ID;

						row4_HashRow.CONTINENT_ID = row4.CONTINENT_ID;

						row4_HashRow.COUNTRY_FORMERNAME = row4.COUNTRY_FORMERNAME;
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBInput_5 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:/2cUipMUxUoPOJi3UxMbuv7ajYs3Ixl1ghTJtg==");
				...
				try {
					...
					while (rs_tDBInput_5.next()) {
						...
						if (colQtyInRs_tDBInput_5 < 1) {
							...
							row5.CONTINENT_ID = rs_tDBInput_5.getDouble(1);
							if (rs_tDBInput_5.wasNull()) {
								row5.CONTINENT_ID = null;
							}
						}
						if (colQtyInRs_tDBInput_5 < 2) {
							row5.CONTINENT_NAME = null;
						} else {

							row5.CONTINENT_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_5, 2, false);
						}
						...
						row5_HashRow.CONTINENT_NAME = row5.CONTINENT_NAME;
	...
	public static void main(String[] args) {
		final geography geographyClass = new geography();

		int exitCode = geographyClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = geography.class.getClassLoader()
					.getResourceAsStream("first/geography_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = geography.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : geography");
		}
...
/************************************************************************************************
 * 185473 characters generated by Talend Open Studio for Data Integration on the
 * January 29, 2024 at 11:51:03 PM CET
 ************************************************************************************************/